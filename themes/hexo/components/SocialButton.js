...
const SocialButton = () => {
  return <div className='w-full justify-center flex-wrap flex'>
    <div className='space-x-3 text-xl text-gray-600 dark:text-gray-300 '>
      ...
      {BLOG.CONTACT_BOOKOPEN && <a target='_blank' rel='noreferrer' title={'bookopen'} href={BLOG.CONTACT_BOOKOPEN} >
        <i className='transform hover:scale-125 duration-150 fas fa-book-open dark:hover:text-indigo-400 hover:text-indigo-600'/>
      </a>}     
      {BLOG.CONTACT_TIKTOK && <a target='_blank' rel='noreferrer' title={'tiktok'} href={BLOG.CONTACT_TIKTOK} >
        <i className='transform hover:scale-125 duration-150 fab fa-tiktok dark:hover:text-indigo-400 hover:text-indigo-600'/>
      </a>}
      {BLOG.CONTACT_WEIXIN && <a target='_blank' rel='noreferrer' title={'weixin'} href={BLOG.CONTACT_WEIXIN} >
        <i className='transform hover:scale-125 duration-150 fab fa-weixin dark:hover:text-indigo-400 hover:text-indigo-600'/>
      </a>} 
      {BLOG.CONTACT_LINE && <a target='_blank' rel='noreferrer' title={'line'} href={BLOG.CONTACT_LINE} >
